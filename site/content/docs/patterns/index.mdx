...
Patterns are higher-level, prop-driven compositions built on the primitives — the recurring page-level pieces (app chrome, dashboards, blog, AI product UI). They live under `@yuhuanowo/yunui/patterns` and `@yuhuanowo/yunui/ai`, and take their framework dependencies (routing, images, i18n) via the [adapters](/docs).
