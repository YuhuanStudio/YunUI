...
declare function Label({ className, size, ...props }: LabelProps): React$1.JSX.Element;
...
interface TextShimmerProps extends Omit<React$1.HTMLAttributes<HTMLSpanElement>, "children"> {
 ...
 */
declare const TextShimmer: React$1.ForwardRefExoticComponent<TextShimmerProps & React$1.RefAttributes<HTMLSpanElement>>;
 ...
 * ```
 */
declare function useDismissOnOutside(open: boolean, onDismiss: () => void, ref: RefObject<HTMLElement | null>, options?: {
    escape?: boolean;
