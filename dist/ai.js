        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "p-2.5 border-b border-border/50", children: [
              ...
              filters && filters.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 mt-2 px-2.5 overflow-x-auto overflow-y-hidden overscroll-x-contain [scrollbar-width:none] [&::-webkit-scrollbar]:hidden", children: [
                filters.map((f) => {
            ...
            groups.length > 1 && /* @__PURE__ */ jsx("div", { className: "px-2.5 py-2 border-b border-border/50 overflow-x-auto overflow-y-hidden overscroll-x-contain [scrollbar-width:none] [&::-webkit-scrollbar]:hidden", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-1 min-w-max", children: [
