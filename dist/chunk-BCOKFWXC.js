...
function Combobox({
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: `relative ${className}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      ...
      clearable && inputValue && !disabled && /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
          onClick: clearValue,
  ...
  /* @__PURE__ */ jsxs(
    DialogPrimitive.Content,
    {
      ...
      className: cn(
        ...
        // Dialogs may be nested above another modal. Keep the content
        // surface opaque so labels and controls below never bleed through.
...
var SelectContent = React7.forwardRef(({ className, children, position = "popper", ...props }, ref) => /* @__PURE__ */ jsx(SelectPrimitive.Portal, { children: /* @__PURE__ */ jsx(
  SelectPrimitive.Content,
  {
    ...
    position,
    className: cn(
      "relative z-50 min-w-32 overflow-hidden rounded-2xl border border-border bg-popover text-popover-foreground shadow-lg shadow-black/5",
      "data-[state=open]:animate-in data-[state=closed]:animate-out",
      "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
...
var TooltipContent = React7.forwardRef(({ className, sideOffset = 4, collisionPadding = 8, ...props }, ref) => /* @__PURE__ */ jsx(TooltipPrimitive.Portal, { children: /* @__PURE__ */ jsx(
...
var DropdownMenuContent = React7.forwardRef(({ className, sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsx(DropdownMenuPrimitive.Portal, { children: /* @__PURE__ */ jsx(
  DropdownMenuPrimitive.Content,
  {
    ...
    sideOffset,
    className: cn(
      "z-50 min-w-32 overflow-hidden rounded-2xl border border-border bg-popover p-1 text-popover-foreground shadow-lg shadow-black/5",
...
//# sourceMappingURL=chunk-BCOKFWXC.js.map
//# sourceMappingURL=chunk-BCOKFWXC.js.map