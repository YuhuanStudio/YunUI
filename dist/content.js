...
function CodeBlock({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-2 border-b bg-muted/50", children: [
...
export { BlockMath, CalloutBlock, CodeBlock, ContentImage, ImageLightbox, InlineCode, InlineMath, MarkdownRenderer, MathRenderer, MermaidDiagram, parseCalloutType };
