"use client";
import { Button, Card, Badge, Avatar, AvatarImage, AvatarFallback, IconButton, Spinner } from './chunk-V23RBWNE.js';
...
function MediaPageHeader({ title, description, isSyncing, syncError, onSync, stats }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxs(Button, { variant: "ghost", size: "sm", onClick: onSync, disabled: isSyncing, className: "text-muted-foreground", children: [
    ...
    stats && stats.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex gap-4 text-sm text-muted-foreground", children: stats.map((stat, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
